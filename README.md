...
- Optionally, a path for a TSV containing the coordinates of the MREs of interest in a tsv via -conservation_tsv. This TSV file can also contain already extracted conservation scores, if you have them precomputed, in one of its columns in a list format and the extraction will work as intended.
